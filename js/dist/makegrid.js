...
/* harmony import */ var _modules_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
...
window.makeGrid = function (t, enableResize, enableReorder, enableVisib, enableGridEdit) {
  ...
  var g = {
    ...
    dragMove: function (e) {
      ...
      if (g.colRsz) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__(g.cCpy).css('left', g.colReorder.objLeft + dx).show();
    ...
    showEditCell: function (cell) {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0__(cell).is('.grid_edit') && !g.colRsz && !g.colReorder) {
        if (!g.isCellEditActive) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0__(g.cEdit).find('.edit_area').empty().hide();
          ...
          if ($cell.attr('data-type') === 'json' && $cell.is('.truncated') === false) {
            value = _modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON(value, null, 4);
          }
    ...
    showEditArea: function () {
      if (!g.isCellEditActive) {
        ...
        if ($td.is('.relation')) {
            ...
            g.lastXHR = jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/sql', {
              ...
              if (typeof data !== 'undefined' && data.success === true) {
                if ($td.attr('data-type') === 'json') {
                  data.value = _modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON(data.value, null, 4);
                }
          ...
          var $inputField = jquery__WEBPACK_IMPORTED_MODULE_0__(g.cEdit).find('.edit_box');
          ...
          // eslint-disable-next-line no-underscore-dangle
          jquery__WEBPACK_IMPORTED_MODULE_0__(document).off('mousedown', jquery__WEBPACK_IMPORTED_MODULE_0__.datepicker._checkExternalClick);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0__(g.cEdit).append(datepickerDiv);
    ...
    postEditedCell: function (options) {
        ...
        $tr.find('.to_be_saved').each(function () {
          ...
          if (isNull) {
            ...
            if ($thisField.attr('data-type') !== 'json') {
              ...
              const JSONString = _modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON($thisField.data('value'));
      ...
      transformFieldsList = jquery__WEBPACK_IMPORTED_MODULE_0__.param(transformFields);
          ...
          if (typeof data !== 'undefined' && data.success === true) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0__(g.t).find('td.to_be_saved').parents('tr').each(function () {
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0__(this).find('a').each(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('href', jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('href').replace(oldClause, newClause));
            ...
            if (typeof data.sql_query !== 'undefined') {
              ...
              if (typeof sqlOuter !== 'undefined' && typeof tools !== 'undefined') {
                ...
                var $existingQuery = jquery__WEBPACK_IMPORTED_MODULE_0__(g.o).find('.result_query');
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0__(g.o).find('div.save_edited').hide();
            // update saved fields
    ...
    saveEditedCell: function () {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0__(g.cEdit).find('.edit_area').is('.edit_area_loading')) {
        ...
        let isValueUpdated;
        if ($thisField.attr('data-type') !== 'json') {
          isValueUpdated = thisFieldParams[fieldName] !== _modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.getCellValue(g.currentEditCell);
        } else {
          const JSONString = _modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.stringifyJSON(thisFieldParams[fieldName]);
          isValueUpdated = JSONString !== JSON.stringify(JSON.parse(_modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.getCellValue(g.currentEditCell)));
        }
    ...
    initColReorder: function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(g.cCpy).hide();
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(g.gDiv).append(g.cCpy);
    ...
    initColVisib: function () {
      ...
      if ($firstRowCols.length > 1) {
        ...
        (0,_modules_tooltip_js__WEBPACK_IMPORTED_MODULE_4__["default"])($colVisibTh, 'th', window.Messages.strColVisibHint);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(thFirst).append(g.cList);
    ...
    initGridEdit: function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(g.cEditStd).hide();
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(g.cEditTextarea).hide();
      ...
      g.maxTruncatedLen = _modules_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('LimitChars');
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(g.t).find('td.data.click2').on('click', function (e) {
        var $cell = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(g.gDiv).append(g.cEditTextarea);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(t).find('th, td:not(:has(span))').wrapInner('<span></span>');
  ...
  g.o = jquery__WEBPACK_IMPORTED_MODULE_0__(t).parents('.sqlqueryresults');

  // get data columns in the first row of the table
  var $firstRowCols = jquery__WEBPACK_IMPORTED_MODULE_0__(t).find('tr').first().find('th.draggable');
  ...
  g.tableCreateTime = jquery__WEBPACK_IMPORTED_MODULE_0__(g.o).find('.table_create_time').val();
  ...
  // add table class
  jquery__WEBPACK_IMPORTED_MODULE_0__(t).addClass('pma_table');

  // add relative position to global div so that resize handlers are correctly positioned
  jquery__WEBPACK_IMPORTED_MODULE_0__(g.gDiv).css('position', 'relative');

  // link the global div
  jquery__WEBPACK_IMPORTED_MODULE_0__(t).before(g.gDiv);
  jquery__WEBPACK_IMPORTED_MODULE_0__(g.gDiv).append(t);
  ...
  (0,_modules_tooltip_js__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__(t).find('th.draggable'), 'th', g.updateHint());
...
/******/ __webpack_require__.O(0, [44], function() { return __webpack_exec__(65); });
