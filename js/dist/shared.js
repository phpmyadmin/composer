...
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _sql_highlight_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _ajax_message_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
/* harmony import */ var _functions_escape_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17);
/* harmony import */ var _functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(18);
/* harmony import */ var _functions_ignorePhpErrors_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(19);
/* harmony import */ var _functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16);
/* harmony import */ var _functions_checkNumberOfFields_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(20);
/* harmony import */ var _functions_mainMenuResizerCallback_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(21);
...
const AJAX = {
  ...
  lockPageHandler: function (event) {
    ...
    if (event.data.value === 3) {
      ...
      if (event.data.value === 1) {
        newHash = AJAX.hash(jquery__WEBPACK_IMPORTED_MODULE_0__(this).val());
      } else {
        newHash = AJAX.hash(jquery__WEBPACK_IMPORTED_MODULE_0__(this).is(':checked'));
      }
    ...
    if (!jquery__WEBPACK_IMPORTED_MODULE_0__.isEmptyObject(AJAX.lockedTargets)) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#lock_page_icon').html((0,_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_6__["default"])('s_lock', window.Messages.strLockToolTip).toString());
    } else {
  ...
  handleMenu: {
    replace: function (content) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#floating_menubar').html(content)
      // Remove duplicate wrapper
      // TODO: don't send it in the response
      .children().first().remove();
      jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenu').menuResizer(_functions_mainMenuResizerCallback_js__WEBPACK_IMPORTED_MODULE_10__["default"]);
    }
  },
  /**
  ...
  requestHandler: function (event) {
    ...
    if (typeof event !== 'undefined' && event.type === 'click' && event.isTrigger !== true && !jquery__WEBPACK_IMPORTED_MODULE_0__.isEmptyObject(AJAX.lockedTargets) && confirm(window.Messages.strConfirmNavigation) === false) {
      return false;
    }
    AJAX.resetLock();
    ...
    if (AJAX.active === true) {
      ...
      if (AJAX.xhr) {
        ...
        if (AJAX.xhr.status === 0 && AJAX.xhr.statusText === 'abort') {
          // If aborted
          AJAX.$msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(window.Messages.strAbortedRequest);
          AJAX.active = false;
          AJAX.xhr = null;
    ...
    AJAX.source = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
    ...
    var argsep = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator');
    ...
    if (isLink) {
      AJAX.active = true;
      AJAX.$msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)();
      // Save reference for the new link request
      AJAX.xhr = jquery__WEBPACK_IMPORTED_MODULE_0__.get(url, params, AJAX.responseHandler);
      var state = {
        url: href
      };
       ...
       */
      var onsubmit = jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('onsubmit');
      ...
      if (typeof onsubmit !== 'function' || onsubmit.apply(this, [event])) {
        ...
        if (jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('id') === 'login_form') {
          jquery__WEBPACK_IMPORTED_MODULE_0__.post(url, params, AJAX.loginResponseHandler);
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0__.post(url, params, AJAX.responseHandler);
        }
      }
    }
  },
  ...
  loginResponseHandler: function (data) {
    ...
    (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxRemoveMessage)(AJAX.$msgbox);
    _navigation_js__WEBPACK_IMPORTED_MODULE_1__.Navigation.update(_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.set('token', data.new_token));
    AJAX.scriptHandler.load([]);
    if (data.displayMessage) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content').prepend(data.displayMessage);
      (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_3__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
    }
    ...
    if (data.errors) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_ignore_errors_bottom').on('click', function (e) {
        e.preventDefault();
        (0,_functions_ignorePhpErrors_js__WEBPACK_IMPORTED_MODULE_7__.ignorePhpErrors)();
      });
      jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_ignore_all_errors_bottom').on('click', function (e) {
        e.preventDefault();
        (0,_functions_ignorePhpErrors_js__WEBPACK_IMPORTED_MODULE_7__.ignorePhpErrors)(false);
      });
      ...
      if (data.sendErrorAlways === '1' && data.stopErrorReportLoop !== '1') {
        ...
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(window.Messages.phpErrorsBeingSubmitted, false);
        jquery__WEBPACK_IMPORTED_MODULE_0__('html, body').animate({
    ...
    (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(msg, false);
    ...
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      if (_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('user') !== data.params.user) {
        window.location = 'index.php';
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(window.Messages.strLoading, false);
        AJAX.active = false;
        AJAX.xhr = null;
        return;
      }
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(data.error, false);
      AJAX.active = false;
      AJAX.xhr = null;
      (0,_functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_8__["default"])(data);
  ...
  responseHandler: function (data) {
    ...
    if (typeof data === 'string') {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxRemoveMessage)(AJAX.$msgbox);
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(jquery__WEBPACK_IMPORTED_MODULE_0__(data).text(), false, 'error');
      AJAX.active = false;
      AJAX.xhr = null;
      return;
    }
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxRemoveMessage)(AJAX.$msgbox);
      if (data.redirect) {
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(data.redirect, false);
        AJAX.active = false;
        AJAX.xhr = null;
        return;
      }
      AJAX.scriptHandler.reset(function () {
        if (data.reloadNavigation) {
          _navigation_js__WEBPACK_IMPORTED_MODULE_1__.Navigation.reload();
        }
        if (data.title) {
        ...
        if (data.disableNaviSettings) {
          _navigation_js__WEBPACK_IMPORTED_MODULE_1__.Navigation.disableSettings();
        } else {
          _navigation_js__WEBPACK_IMPORTED_MODULE_1__.Navigation.ensureSettings(data.selflink);
        }

        // Remove all containers that may have
        // been added outside of #page_content
        jquery__WEBPACK_IMPORTED_MODULE_0__('body').children().not('div.modal').not('#pma_navigation').not('#floating_menubar').not('#page_nav_icons').not('#page_content').not('#selflink').not('#pma_header').not('#pma_footer').not('#pma_demo').not('#pma_console_container').not('#prefs_autoload').remove();
        // Replace #page_content with new content
        if (data.message && data.message.length > 0) {
          jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content').replaceWith('<div id=\'page_content\'>' + data.message + '</div>');
          (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_3__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
          (0,_functions_checkNumberOfFields_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
        }
        if (data.selflink) {
        ...
        if (data.params) {
          _navigation_js__WEBPACK_IMPORTED_MODULE_1__.Navigation.update(_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.setAll(data.params));
        }
        if (data.scripts) {
  ...
  scriptHandler: {
    ...
    load: function (files, callback) {
      ...
      if (self.scriptsVersion === null) {
        self.scriptsVersion = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('version');
      } else if (self.scriptsVersion !== _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('version')) {
        self.scripts = [];
        self.scriptsVersion = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('version');
      }
    ...
    appendScript: function (name, callback) {
      ...
      script.src = 'js/' + file + '?' + 'v=' + encodeURIComponent(_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('version'));
      script.async = false;
    ...
    reset: function (callback) {
       ...
       */
      jquery__WEBPACK_IMPORTED_MODULE_0__(document).off('click', 'a').on('click', 'a', AJAX.requestHandler);
      jquery__WEBPACK_IMPORTED_MODULE_0__(document).off('submit', 'form').on('submit', 'form', AJAX.requestHandler);
      callback();
    }
  },
  /**
  ...
  loadEventHandler: function () {
    return function () {
      var menuContent = jquery__WEBPACK_IMPORTED_MODULE_0__('<div></div>').append(jquery__WEBPACK_IMPORTED_MODULE_0__('#server-breadcrumb').clone()).append(jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenucontainer').clone()).html();
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(window).on('popstate', function (event) {
        ...
        if (state && state.menu) {
          AJAX.$msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)();
          var params = 'ajax_request=true' + _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + 'ajax_page_request=true';
          var url = state.url || location.href;
          jquery__WEBPACK_IMPORTED_MODULE_0__.get(url, params, AJAX.responseHandler);
    ...
    return function (event, request) {
      ...
      if (request.status !== 0 || request.statusText !== 'abort') {
        ...
        if ('responseJSON' in request && 'isErrorResponse' in request.responseJSON && request.responseJSON.isErrorResponse) {
          (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)('<div class="alert alert-danger" role="alert">' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_5__.escapeHtml)(request.responseJSON.error) + '</div>', false);
          AJAX.active = false;
          AJAX.xhr = null;
          return;
        }
        if (request.status !== 0) {
          details += '<div>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_5__.escapeHtml)(window.sprintf(window.Messages.strErrorCode, request.status)) + '</div>';
        }
        details += '<div>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_5__.escapeHtml)(window.sprintf(window.Messages.strErrorText, request.statusText + ' (' + state + ')')) + '</div>';
        if (state === 'rejected' || state === 'timeout') {
          details += '<div>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_5__.escapeHtml)(window.Messages.strErrorConnection) + '</div>';
        }
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)('<div class="alert alert-danger" role="alert">' + window.Messages.strErrorProcessingRequest + details + '</div>', false);
        AJAX.active = false;
        AJAX.xhr = null;
      }
    };
...
/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9);
/* harmony import */ var _ajax_message_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
/* harmony import */ var _functions_config_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
/* harmony import */ var _functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16);
/* harmony import */ var _functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13);
...
Navigation.treeStateUpdate = function () {
  ...
  if ((0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_6__["default"])('sessionStorage')) {
    ...
    try {
      ...
      storage.setItem('server', _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('server'));
      storage.setItem('token', _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('token'));
    } catch (error) {
...
Navigation.filterStateRestore = function () {
  if ((0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_6__["default"])('sessionStorage') && typeof window.sessionStorage.navTreeSearchFilters !== 'undefined') {
    ...
    var $tableFilters = jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree li.database').children('div.list_container').find('li.fast_filter input.searchClause');
    // restore table filters
    $tableFilters.each(function () {
      $obj = jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('div.list_container');
      // aPath associated with this filter
      var filterName = jquery__WEBPACK_IMPORTED_MODULE_0__(this).siblings('input[name=aPath]').val();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/navigation&ajax_request=1', params, function (data) {
    if (typeof data !== 'undefined' && data.success === true) {
      ...
      if (window.location.href.indexOf('?') === -1) {
        ...
        window.location.href += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + 'session_expired=1';
      }
      ...
      $icon.show();
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_3__.ajaxShowMessage)(data.error, false);
    }
  });
};
...
Navigation.showCurrent = function () {
  var db = _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('db');
  var table = _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('table');
  ...
  function findLoadedItem($container, name, clazz, doSelect) {
    ...
    $container.children('ul').children('li').each(function () {
      var $li = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_settings').length) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/navigation&ajax_request=1', params, function (data) {
      if (typeof data !== 'undefined' && data.success) {
        ...
        _config_js__WEBPACK_IMPORTED_MODULE_2__.Config.setupRestoreField();
        _config_js__WEBPACK_IMPORTED_MODULE_2__.Config.setupValidation();
...
Navigation.reload = function () {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('#navi_db_select').length) {
    params.db = _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('db');
...
Navigation.selectCurrentDatabase = function () {
  ...
  if (_common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('db')) {
    // db selected
    $naviDbSelect.show();
  }
  $naviDbSelect.val(_common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('db'));
  return $naviDbSelect.val() === _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('db');
};
...
Navigation.treePagination = function ($this) {
  var $msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_3__.ajaxShowMessage)();
  var isDbSelector = $this.closest('div.pageselector').is('.dbselector');
  var url = 'index.php?route=/navigation';
  var params = 'ajax_request=true';
  if ($this[0].tagName === 'A') {
    params += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + $this.getPostData();
  } else {
    // tagName === 'SELECT'
    params += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + $this.closest('form').serialize();
  }
  var searchClause = Navigation.FastFilter.getSearchClause();
  if (searchClause) {
    params += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + 'searchClause=' + encodeURIComponent(searchClause);
  }
  if (isDbSelector) {
    params += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + 'full=true';
  } else {
    var searchClause2 = Navigation.FastFilter.getSearchClause2($this);
    if (searchClause2) {
      params += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + 'searchClause2=' + encodeURIComponent(searchClause2);
    }
  }
  jquery__WEBPACK_IMPORTED_MODULE_0__.post(url, params, function (data) {
    if (typeof data !== 'undefined' && data.success) {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_3__.ajaxRemoveMessage)($msgbox);
      var val;
      if (isDbSelector) {
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_3__.ajaxShowMessage)(data.error);
      (0,_functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_5__["default"])(data);
    }
    Navigation.treeStateUpdate();
  });
};
...
Navigation.ResizeHandler = function () {
  ...
  this.setWidth = function (position) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('body').css('margin-' + this.left, pos + 'px');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#floating_menubar').css('margin-' + this.left, jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation').width() + jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_resizer').width()).css(this.left, 0).css({
      ...
      'width': '100%',
      'z-index': 99
    }).append(jquery__WEBPACK_IMPORTED_MODULE_0__('#server-breadcrumb')).append(jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenucontainer'));
  ...
  this.mouseup = function (event) {
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_4__.setConfigValue)('NavigationWidth', event.data.resize_handler.getPos(event));
  ...
  this.collapse = function (event) {
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_4__.setConfigValue)('NavigationWidth', panelWidth);
  ...
  this.treeInit = function () {
    const isLoadedOnMobile = jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() < 768;
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_collapser').html(this.getSymbol(jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation').width()));
    // Fix navigation tree height
    jquery__WEBPACK_IMPORTED_MODULE_0__(window).on('resize', this.treeResize);
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_4__.getConfigValue)('NavigationWidth', false, callbackSuccessGetConfigValue);
  };
  this.treeInit();
};
...
Navigation.FastFilter.Filter.prototype.request = function () {
  ...
  if (self.$this.find('> ul > li > form.fast_filter').first().find('input[name=searchClause]').length === 0) {
    var $input = jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree').find('li.fast_filter.db_fast_filter input.searchClause');
    if ($input.length && $input.val() !== $input[0].defaultValue) {
      params += _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('arg_separator') + 'searchClause=' + encodeURIComponent($input.val());
    }
  }
  self.xhr = jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
    url: 'index.php?route=/navigation&ajax_request=1&server=' + _common_js__WEBPACK_IMPORTED_MODULE_1__.CommonParams.get('server'),
    type: 'post',
    dataType: 'json',
    data: params,
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _ajax_message_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
/* harmony import */ var _functions_formatDateTime_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
...
Config.displayErrors = function (errorList) {
  ...
  for (var fieldId in errorList) {
    ...
    errors = jquery__WEBPACK_IMPORTED_MODULE_0__.grep(errors, tempIsEmpty);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
    ...
    success: function (data) {
      if (typeof data !== 'undefined' && data.success === true) {
        ...
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_2__.ajaxShowMessage)(data.error);
      }
    },
    complete: function () {
...
function updatePrefsDate() {
  ...
  var msg = window.Messages.strSavedOn.replace('@DATE@', (0,_functions_formatDateTime_js__WEBPACK_IMPORTED_MODULE_4__["default"])(d));
...
function offerPrefsAutoimport() {
  var hasConfig = (0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_3__["default"])('localStorage') && (window.localStorage.config || false);
...
Config.on = function () {
  return function () {
    ...
    var lsSupported = (0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_3__["default"])('localStorage', true);
...
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _tooltip_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
/* harmony import */ var _sql_highlight_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
const ajaxShowMessage = function () {
   ...
   */
  var $retval = jquery__WEBPACK_IMPORTED_MODULE_0__('<span class="ajax_notification" id="ajax_message_num_' + ajaxMessageCount + '"></span>').hide().appendTo('#loading_parent').html(msg).show();
...
function documentationAdd($elm, params) {
  ...
  var url = window.sprintf(decodeURIComponent(mysqlDocTemplate), params[0]);
  if (params.length > 1) {
...
/* harmony export */ });
/* harmony import */ var _ajax_message_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
...
function isStorageSupported(type) {
  ...
  try {
    ...
    // Not supported
    if (warn) {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_0__.ajaxShowMessage)(window.Messages.strNoLocalStorage, false);
    }
  }
  return false;
}
...
/* harmony export */ });
/* harmony import */ var _escape_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
...
/* harmony import */ var _tooltip_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11);
/* harmony import */ var _sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
/* harmony import */ var _ajax_message_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10);
/* harmony import */ var _functions_escape_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
/* harmony import */ var _functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
/* harmony import */ var _functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(16);
/* harmony import */ var _functions_refreshMainContent_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(23);
/* harmony import */ var _indexes_checkIndexType_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(24);
/* harmony import */ var _indexes_checkIndexName_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(25);
/* harmony import */ var _functions_mainMenuResizerCallback_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(21);
/* harmony import */ var _functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(13);
...
Functions.addNoCacheToAjaxRequests = () => function (options, originalOptions) {
  ...
  if (typeof options.data === 'string') {
    options.data += '&_nocache=' + nocache + '&token=' + encodeURIComponent(_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('token'));
  } else if (typeof options.data === 'object') {
    options.data = jquery__WEBPACK_IMPORTED_MODULE_0__.extend(originalOptions.data, {
      '_nocache': nocache,
      'token': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('token')
    });
  }
};
...
Functions.addDatepicker = function ($thisElement, type, options) {
  ...
  var defaultOptions = {
    ...
    beforeShow: function (input, inst) {
      ...
      setTimeout(function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__('#ui-timepicker-div').css('z-index', jquery__WEBPACK_IMPORTED_MODULE_0__('#ui-datepicker-div').css('z-index'));
  ...
  if (type === 'time') {
    ...
    (0,_tooltip_js__WEBPACK_IMPORTED_MODULE_4__["default"])($thisElement, 'input', window.Messages.strMysqlAllowedValuesTipTime);
  } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__.timepicker !== undefined) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('input.timefield, input.datefield, input.datetimefield').each(function () {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0__(this).hasClass('timefield')) {
        (0,_tooltip_js__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__(this), 'input', window.Messages.strMysqlAllowedValuesTipTime);
      } else if (jquery__WEBPACK_IMPORTED_MODULE_0__(this).hasClass('datefield')) {
        (0,_tooltip_js__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__(this), 'input', window.Messages.strMysqlAllowedValuesTipDate);
      }
    });
  }
};
...
Functions.getSqlEditor = function ($textarea, options, resize, lintOptions) {
  ...
  if ($textarea.length > 0 && typeof window.CodeMirror !== 'undefined') {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.extend(true, defaults, options);
    ...
    codemirrorEditor.on('change', function (e) {
      ...
      _ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.lockPageHandler(e);
    });
...
Functions.confirmLink = function (theLink, theSqlQuery) {
  ...
  if (isConfirmed) {
    if (typeof theLink.href !== 'undefined') {
      theLink.href += _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'is_js_confirmed=1';
...
Functions.onloadIdleEvent = function () {
  ...
  function UpdateIdleTime() {
    ...
    var guid = 'default';
    if ((0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_14__["default"])('sessionStorage')) {
      guid = window.sessionStorage.guid;
    }
    var params = {
      'ajax_request': true,
      'server': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('server'),
      'db': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('db'),
      'guid': guid,
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      ...
      success: function (data) {
        if (data.success) {
          if (_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('LoginCookieValidity') - idleSecondsCounter < 0) {
            /* There is other active window, let's reset counter */
            idleSecondsCounter = 0;
          }
          var remaining = Math.min( /* Remaining login validity */
          _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('LoginCookieValidity') - idleSecondsCounter, /* Remaining time till session GC */
          _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('session_gc_maxlifetime'));
          var interval = 1000;
          if (remaining > 5) {
          ...
          idleSecondsCounter = 0;
          (0,_functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_9__["default"])(data);
        }
      }
    });
  }
...
Functions.getForeignKeyCheckboxLoader = function () {
  ...
  html += (0,_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_8__["default"])('ajax_clock_small');
  html += '</div>';
  html += '</div>';
  return html;
};
...
Functions.onloadSqlQueryEditEvents = function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.inline_edit_sql', function () {
    ...
    var newContent = '<textarea name="sql_query_edit" id="sql_query_edit">' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(sqlQuery) + '</textarea>\n';
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
        ...
        success: function (data) {
          if (data.success) {
            ...
            sqlAutoCompleteDefaultTable = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('table');
            sqlAutoComplete = [];
...
Functions.updateCode = function ($base, htmlValue, rawValue) {
  ...
  var $notHighlighted = jquery__WEBPACK_IMPORTED_MODULE_0__('<pre>' + htmlValue + '</pre>');
...
Functions.previewSql = function ($form) {
  ...
  var $messageBox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)();
  jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
    type: 'POST',
    url: formUrl,
    data: formData,
    success: function (response) {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxRemoveMessage)($messageBox);
      if (response.success) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__('#previewSqlModal').on('shown.bs.modal', function () {
          (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#previewSqlModal'));
        });
      } else {
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)(response.message);
      }
    },
    error: function () {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)(window.Messages.strErrorProcessingRequest);
    }
  });
};
...
Functions.confirmPreviewSql = function (sqlData, url, callback) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#previewSqlConfirmModal').on('shown.bs.modal', function () {
    (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#previewSqlConfirmModal'));
  });
...
Functions.dismissNotifications = () => function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('mouseup', 'span.ajax_notification.dismissable', function (event) {
    if (holdStarter && event.which === 1) {
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxRemoveMessage)(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
    }
  });
  /**
...
Functions.confirm = function (question, url, callbackFn, openCallback) {
  var confirmState = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('confirm');
  if (!confirmState) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#functionConfirmOkButton').off('click'); // Un-register previous modals
...
Functions.sortTable = function (textSelector) {
  return this.each(function () {
     ...
     */
    var rows = jquery__WEBPACK_IMPORTED_MODULE_0__(this).find('tr').get();
...
Functions.onloadCreateTableEvents = function () {
      ...
      if (Functions.checkReservedWordColumns($form)) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__.post($form.attr('action'), $form.serialize() + _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'do_save_data=1', function (data) {
          if (typeof data !== 'undefined' && data.success === true) {
            ...
            (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)(data.message);
            ...
            if (tablesTable.length === 0) {
              (0,_functions_refreshMainContent_js__WEBPACK_IMPORTED_MODULE_10__["default"])(_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('opendb_url'));
            } else {
              /**
              ...
              // append to table
              jquery__WEBPACK_IMPORTED_MODULE_0__(data.newTableString).appendTo(tablesTable);

              // Sort the table
              jquery__WEBPACK_IMPORTED_MODULE_0__(tablesTable).sortTable('th');
            ...
            var argsep = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator');
            ...
            (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)('<div class="alert alert-danger" role="alert">' + data.error + '</div>', false);
          }
        }); // end $.post()
      }
    }
  ...
  function submitChangesInCreateTableForm(actionParam) {
    ...
    var $msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)(window.Messages.strProcessingRequest);
    Functions.prepareForAjaxRequest($form);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.post($form.attr('action'), $form.serialize() + '&' + actionParam, function (data) {
      if (typeof data !== 'undefined' && data.success) {
        ...
        (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])($pageContent);
        ...
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)(data.error);
      }
    }); // end $.post()
  }
...
Functions.onloadChangePasswordEvents = function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#change_password_anchor.ajax', function (event) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.get(jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('href'), {
      ...
      if (data.scripts) {
        _ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.scriptHandler.load(data.scripts);
      }
...
Functions.autoPopulate = function (inputId, offset) {
  var db = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('db');
  var table = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('table');
...
Functions.onloadEnumSetEditor = function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.open_enum_editor', function () {
    ...
    if (colname.length < 1) {
      ...
      title = window.Messages.enum_columnVals.replace(/%s/, '"' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(decodeURIComponent(colname)) + '"');
    }
    // Get the values as a string
    var inputstring = jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('td').find('input').val();
    // Escape html entities
    inputstring = jquery__WEBPACK_IMPORTED_MODULE_0__('<div></div>').text(inputstring).html();
    ...
    var dropIcon = (0,_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_8__["default"])('b_drop');
     ...
     */
    var dialog = '<div id=\'enum_editor\'>' + '<fieldset class="pma-fieldset">' + '<legend>' + title + '</legend>' + '<p>' + (0,_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_8__["default"])('s_notice') + window.Messages.enum_hint + '</p>' + '<table class="table table-borderless values">' + fields + '</table>' + '</fieldset><fieldset class="pma-fieldset tblFooters">' + '<table class="table table-borderless add"><tr><td>' + '<div class=\'slider\'></div>' + '</td><td>' + '<form><div><input type=\'submit\' class=\'add_value btn btn-primary\' value=\'' + window.sprintf(window.Messages.enum_addValue, 1) + '\'></div></form>' + '</td></tr></table>' + '<input type=\'hidden\' value=\'' +
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#enumEditorModal').find('.modal-body').first().html(dialog);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#enumEditorModal').find('.slider').slider({
      ...
      slide: function (event, ui) {
        jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('table').find('input[type=submit]').val(window.sprintf(window.Messages.enum_addValue, ui.value));
      }
    });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.central_columns_dialog', function () {
    ...
    var params = {
      ...
      'server': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('server'),
      'db': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('db'),
      'cur_table': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('table'),
      'getColumnList': true
    };
    ...
    for (i = 0; i < min; i++) {
      fields += '<tr><td><div><span class="fw-bold">' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(window.centralColumnList[db + '_' + table][i].col_name) + '</span><br><span class="color_gray">' + window.centralColumnList[db + '_' + table][i].col_type;
      if (window.centralColumnList[db + '_' + table][i].col_attribute !== '') {
        fields += '(' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(window.centralColumnList[db + '_' + table][i].col_attribute) + ') ';
      }
      if (window.centralColumnList[db + '_' + table][i].col_length !== '') {
        fields += '(' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(window.centralColumnList[db + '_' + table][i].col_length) + ') ';
      }
      fields += (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(window.centralColumnList[db + '_' + table][i].col_extra) + '</span>' + '</div></td>';
      if (pick) {
    ...
    if (fields === '') {
      fields = window.sprintf(window.Messages.strEmptyCentralList, '\'' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(db) + '\'');
      searchIn = '';
    }
    var seeMore = '';
    if (listSize > maxRows) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'input.add_value', function (e) {
    ...
    while (numNewRows--) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#enumEditorModal').find('.values').append('<tr class=\'hide\'><td>' + '<input type=\'text\'>' + '</td><td class=\'drop\'>' + (0,_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_8__["default"])('b_drop') + '</td></tr>').find('tr').last().show('fast');
    }
  });
...
Functions.indexDialogModal = function (routeUrl, url, title, callbackSuccess, callbackFailure) {
  ...
  indexDialogPreviewModal.addEventListener('shown.bs.modal', () => {
    ...
    const sep = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.post({
      ...
      success: response => {
        ...
        (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#indexDialogPreviewModal'));
      },
      error: () => {
        modalBody.innerHTML = '<div class="alert alert-danger" role="alert">' + window.Messages.strErrorProcessingRequest + '</div>';
      }
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#indexDialogModalGoButton').off('click');
  jquery__WEBPACK_IMPORTED_MODULE_0__('#indexDialogModalGoButton').on('click', function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.post($form.attr('action'), $form.serialize() + _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'do_save_data=1', function (data) {
      ...
      if (typeof data !== 'undefined' && data.success === true) {
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)(data.message);
        (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('.result_query'));
        ...
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)($error, false);
      }
    }); // end $.post()
  });
...
Functions.showIndexEditDialog = function ($outer) {
  (0,_indexes_checkIndexType_js__WEBPACK_IMPORTED_MODULE_11__["default"])();
  (0,_indexes_checkIndexName_js__WEBPACK_IMPORTED_MODULE_12__["default"])('index_frm');
  var $indexColumns = jquery__WEBPACK_IMPORTED_MODULE_0__('#index_columns');
  ...
  $outer.find('.slider').slider({
    ...
    max: 16,
    slide: function (event, ui) {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('fieldset').find('input[type=submit]').val(window.sprintf(window.Messages.strAddToIndex, ui.value));
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('div.add_fields').removeClass('hide');
  // focus index size input on column picked
...
Functions.showHints = function ($div) {
  ...
  $newDiv.find('.pma_hint').each(function () {
    (0,_tooltip_js__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__(this).children('img'), 'img', jquery__WEBPACK_IMPORTED_MODULE_0__(this).children('span').html());
  });
};
...
Functions.initializeMenuResizer = () => function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenu').menuResizer(_functions_mainMenuResizerCallback_js__WEBPACK_IMPORTED_MODULE_13__["default"]);
...
Functions.toggleButton = function ($obj) {
  ...
  var off = jquery__WEBPACK_IMPORTED_MODULE_0__('td.toggleOff', $obj).width();
   ...
   */
  var w = parseInt(jquery__WEBPACK_IMPORTED_MODULE_0__('img', $obj).height() / 16 * 22, 10);
  ...
  var btnw = jquery__WEBPACK_IMPORTED_MODULE_0__($obj).find('table td').eq(1).outerWidth();
   ...
   */
  var move = jquery__WEBPACK_IMPORTED_MODULE_0__('td.toggleOff', $obj).outerWidth();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('div.toggle-container', $obj).on('click', function () {
    ...
    var $msg = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_6__.ajaxShowMessage)();
...
Functions.onloadRecentFavoriteTables = () => {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('#sync_favorite_tables').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      ...
      type: 'POST',
      data: {
        'favoriteTables': (0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_14__["default"])('localStorage') && typeof window.localStorage.favoriteTables !== 'undefined' ? window.localStorage.favoriteTables : '',
        'server': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('server'),
        'no_debug': true
      },
      success: function (data) {
        // Update localStorage.
        if ((0,_functions_isStorageSupported_js__WEBPACK_IMPORTED_MODULE_14__["default"])('localStorage')) {
...
Functions.slidingMessage = function (msg, $object) {
  ...
  if ($obj.has('div').length > 0) {
    ...
    $obj.find('div').first().fadeOut(function () {
      ...
      (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])($obj);
...
Functions.onloadCodeMirrorEditor = () => {
  ...
  (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('body'));
};
...
Functions.onloadLockPage = function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content form.lock-page textarea, ' + '#page_content form.lock-page input[type="text"], ' + '#page_content form.lock-page input[type="number"], ' + '#page_content form.lock-page select').each(function (i) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('val-hash', _ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.hash(jquery__WEBPACK_IMPORTED_MODULE_0__(this).val()));
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content form.lock-page input[type="checkbox"], ' + '#page_content form.lock-page input[type="radio"]').each(function (i) {
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('lock-id', i);
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('val-hash', _ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.hash(jquery__WEBPACK_IMPORTED_MODULE_0__(this).is(':checked')));
  });
};
...
Functions.onloadCreateView = function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.logout').on('click', function () {
    var form = jquery__WEBPACK_IMPORTED_MODULE_0__('<form method="POST" action="' + jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('href') + '" class="disableAjax">' + '<input type="hidden" name="token" value="' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_7__.escapeHtml)(_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('token')) + '">' + '</form>');
...
Functions.checkboxesChanged = function () {
  var $form = jquery__WEBPACK_IMPORTED_MODULE_0__(this.form);
...
Functions.onloadLoginForm = () => {
  ...
  if ($httpsWarning.length) {
    if (window.location.protocol === 'https:' !== _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('is_https')) {
      $httpsWarning.show();
    }
  }
};
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _ajax_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _functions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3);
/* harmony import */ var _sql_highlight_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
/* harmony import */ var _ajax_message_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10);
/* harmony import */ var _functions_getJsConfirmCommonParam_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(30);
/* harmony import */ var _functions_refreshMainContent_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(23);
/* harmony import */ var _indexes_checkIndexType_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(24);
/* harmony import */ var _indexes_checkIndexName_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(25);
...
Indexes.removeColumnFromIndex = function (colIndex) {
  ...
  if (previousIndex.length) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('select[name="field_key[' + colIndex + ']"]').attr('data-index', '');
...
Indexes.getCompositeIndexList = function (sourceArray, colIndex) {
  ...
  // Html list.
  var $compositeIndexList = jquery__WEBPACK_IMPORTED_MODULE_0__('<ul id="composite_index_list">' + '<div>' + window.Messages.strCompositeWith + '</div>' + '</ul>');
