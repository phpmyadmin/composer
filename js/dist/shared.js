...
/* harmony import */ var _ajax_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
const CommonActions = {
  ...
  refreshMain: function (url) {
    ...
    if (typeof callback !== 'undefined') {
      _ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.callback = callback;
    }
  }
};
...
const AJAX = {
  ...
  lockPageHandler: function (event) {
    ...
    if (!jquery__WEBPACK_IMPORTED_MODULE_0__.isEmptyObject(AJAX.lockedTargets)) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#lock_page_icon').html(_functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.getImage('s_lock', window.Messages.strLockToolTip).toString());
    } else {
  ...
  handleMenu: {
    replace: function (content) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenu').menuResizer(_functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.mainMenuResizerCallback);
    }
  },
  ...
  requestHandler: function (event) {
    ...
    if (AJAX.active === true) {
      ...
      if (AJAX.xhr) {
        ...
        if (AJAX.xhr.status === 0 && AJAX.xhr.statusText === 'abort') {
          // If aborted
          AJAX.$msgbox = _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(window.Messages.strAbortedRequest);
          AJAX.active = false;
          AJAX.xhr = null;
    ...
    if (isLink) {
      AJAX.active = true;
      AJAX.$msgbox = _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(); // Save reference for the new link request
      ...
      if (typeof onsubmit !== 'function' || onsubmit.apply(this, [event])) {
        AJAX.active = true;
        AJAX.$msgbox = _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage();
  ...
  loginResponseHandler: function (data) {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxRemoveMessage(AJAX.$msgbox);
    ...
    if (data.displayMessage) {
      ...
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.highlightSql(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
    }
    ...
    if (data.errors) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_ignore_errors_bottom').on('click', function (e) {
        e.preventDefault();
        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ignorePhpErrors();
      });
      jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_ignore_all_errors_bottom').on('click', function (e) {
        e.preventDefault();
        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ignorePhpErrors(false);
      ...
      if (data.sendErrorAlways === '1' && data.stopErrorReportLoop !== '1') {
        ...
        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(window.Messages.phpErrorsBeingSubmitted, false);
        jquery__WEBPACK_IMPORTED_MODULE_0__('html, body').animate({
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(msg, false); // bind for php error reporting forms (popup)
    ...
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      if (_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('user') !== data.params.user) {
        window.location = 'index.php';
        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(window.Messages.strLoading, false);
        AJAX.active = false;
        AJAX.xhr = null;
        return;
      ...
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(data.error, false);
      AJAX.active = false;
      AJAX.xhr = null;
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.handleRedirectAndReload(data);
  ...
  responseHandler: function (data) {
    ...
    if (typeof data === 'string') {
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxRemoveMessage(AJAX.$msgbox);
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(jquery__WEBPACK_IMPORTED_MODULE_0__(data).text(), false, 'error');
      AJAX.active = false;
      AJAX.xhr = null;
      return;
    }
    ...
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      if (data.redirect) {
        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(data.redirect, false);
        AJAX.active = false;
        AJAX.xhr = null;
        return;
      }
      ...
      AJAX.scriptHandler.reset(function () {
        ...
        if (data.disableNaviSettings) {
          _navigation_js__WEBPACK_IMPORTED_MODULE_2__.Navigation.disableSettings();
        } else {
          _navigation_js__WEBPACK_IMPORTED_MODULE_2__.Navigation.ensureSettings(data.selflink);
        ...
        if (data.message && data.message.length > 0) {
          ...
          _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.highlightSql(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
          _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.checkNumberOfFields();
        }
  ...
  scriptHandler: {
    ...
    load: function (files, callback) {
      ...
      if (self.scriptsVersion === null) {
        self.scriptsVersion = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('version');
      } else if (self.scriptsVersion !== _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('version')) {
        self.scripts = [];
        self.scriptsVersion = _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('version');
      }
    ...
    appendScript: function (name, callback) {
      ...
      script.src = 'js/' + file + '?' + 'v=' + encodeURIComponent(_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('version'));
      script.async = false;
  ...
  loadEventHandler: function () {
    return function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__(window).on('popstate', function (event) {
        ...
        if (state && state.menu) {
          AJAX.$msgbox = _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage();
          var params = 'ajax_request=true' + _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'ajax_page_request=true';
          var url = state.url || location.href;
          jquery__WEBPACK_IMPORTED_MODULE_0__.get(url, params, AJAX.responseHandler); // TODO: Check if sometimes menu is not retrieved from server,
    ...
    return function (event, request) {
      ...
      if (request.status !== 0 || request.statusText !== 'abort') {
        ...
        if ('responseJSON' in request && 'isErrorResponse' in request.responseJSON && request.responseJSON.isErrorResponse) {
          _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage('<div class="alert alert-danger" role="alert">' + _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.escapeHtml(request.responseJSON.error) + '</div>', false);
          AJAX.active = false;
          AJAX.xhr = null;
          return;
        }
        ...
        if (request.status !== 0) {
          details += '<div>' + _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.escapeHtml(window.sprintf(window.Messages.strErrorCode, request.status)) + '</div>';
        }

        details += '<div>' + _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.escapeHtml(window.sprintf(window.Messages.strErrorText, request.statusText + ' (' + state + ')')) + '</div>';

        if (state === 'rejected' || state === 'timeout') {
          details += '<div>' + _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.escapeHtml(window.Messages.strErrorConnection) + '</div>';
        }

        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage('<div class="alert alert-danger" role="alert">' + window.Messages.strErrorProcessingRequest + details + '</div>', false);
        AJAX.active = false;
        AJAX.xhr = null;
      }
    };
...
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
/* harmony import */ var _doc_links_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _indexes_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
...
Functions.handleRedirectAndReload = function (data) {
  if (parseInt(data.redirect_flag) === 1) {
    ...
    if (window.location.href.indexOf('?') === -1) {
      ...
      window.location.href += _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'session_expired=1';
    }
...
Functions.confirmQuery = function (theForm1, sqlQuery1) {
  ...
  if (doConfirmRegExp0.test(sqlQuery1) || doConfirmRegExp1.test(sqlQuery1) || doConfirmRegExp2.test(sqlQuery1) || doConfirmRegExp3.test(sqlQuery1) || doConfirmRegExp4.test(sqlQuery1)) {
    ...
    var isConfirmed = confirm(window.sprintf(window.Messages.strDoYouReally, message)); // statement is confirmed -> update the
...
Functions.onloadIdleEvent = function () {
  ...
  function UpdateIdleTime() {
    ...
    if (_config_js__WEBPACK_IMPORTED_MODULE_6__.Config.isStorageSupported('sessionStorage')) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      ...
      success: function (data) {
        if (data.success) {
          ...
          _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('LoginCookieValidity') - idleSecondsCounter,
...
Functions.documentationKeyword = function (idx, elm) {
  ...
  if ($next) {
    ...
    if ($next2) {
      ...
      if (full2 in _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword) {
        Functions.documentationAdd($elm, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword[full2]);
        Functions.documentationAdd($next, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword[full2]);
        Functions.documentationAdd($next2, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword[full2]);
        return;
      }
    }

    if (full in _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword) {
      Functions.documentationAdd($elm, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword[full]);
      Functions.documentationAdd($next, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword[full]);
      return;
    }
  }

  if (keyword in _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword) {
    Functions.documentationAdd($elm, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocKeyword[keyword]);
  }
};
/**
...
Functions.documentationBuiltin = function (idx, elm) {
  ...
  if (builtin in _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocBuiltin) {
    Functions.documentationAdd($elm, _doc_links_js__WEBPACK_IMPORTED_MODULE_4__.mysqlDocBuiltin[builtin]);
  }
};
/**
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__.post($form.attr('action'), $form.serialize() + _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'do_save_data=1', function (data) {
          if (typeof data !== 'undefined' && data.success === true) {
            ...
            if (tablesTable.length === 0) {
              _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonActions.refreshMain(_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('opendb_url'));
            } else {
              /**
            ...
            _navigation_js__WEBPACK_IMPORTED_MODULE_2__.Navigation.reload(); // Redirect to table structure page on creation of new table
...
Functions.onloadEnumSetEditor = function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.open_enum_editor', function () {
    ...
    var dialog = '<div id=\'enum_editor\'>' + '<fieldset class="pma-fieldset">' + '<legend>' + title + '</legend>' + '<p>' + Functions.getImage('s_notice') + window.Messages.enum_hint + '</p>' + '<table class="table table-borderless values">' + fields + '</table>' + '</fieldset><fieldset class="pma-fieldset tblFooters">' + '<table class="table table-borderless add"><tr><td>' + '<div class=\'slider\'></div>' + '</td><td>' + '<form><div><input type=\'submit\' class=\'add_value btn btn-primary\' value=\'' + window.sprintf(window.Messages.enum_addValue, 1) + '\'></div></form>' + '</td></tr></table>' + '<input type=\'hidden\' value=\'' + // So we know which column's data is being edited
...
Functions.showIndexEditDialog = function ($outer) {
  _indexes_js__WEBPACK_IMPORTED_MODULE_5__.Indexes.checkIndexType();
...
Functions.onloadRecentFavoriteTables = () => {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('#sync_favorite_tables').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      ...
      type: 'POST',
      data: {
        'favoriteTables': _config_js__WEBPACK_IMPORTED_MODULE_6__.Config.isStorageSupported('localStorage') && typeof window.localStorage.favoriteTables !== 'undefined' ? window.localStorage.favoriteTables : '',
        'server': _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('server'),
        'no_debug': true
      },
      success: function (data) {
        // Update localStorage.
        if (_config_js__WEBPACK_IMPORTED_MODULE_6__.Config.isStorageSupported('localStorage')) {
...
Functions.onloadCreateView = function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.logout').on('click', function () {
    var form = jquery__WEBPACK_IMPORTED_MODULE_0__('<form method="POST" action="' + jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('href') + '" class="disableAjax">' + '<input type="hidden" name="token" value="' + Functions.escapeHtml(_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('token')) + '">' + '</form>');
...
/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
...
Navigation.treeStateUpdate = function () {
  ...
  if (_config_js__WEBPACK_IMPORTED_MODULE_3__.Config.isStorageSupported('sessionStorage')) {
    ...
    try {
      ...
      storage.setItem('server', _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('server'));
      storage.setItem('token', _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('token'));
    } catch (error) {
...
Navigation.filterStateRestore = function () {
  if (_config_js__WEBPACK_IMPORTED_MODULE_3__.Config.isStorageSupported('sessionStorage') && typeof window.sessionStorage.navTreeSearchFilters !== 'undefined') {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/navigation&ajax_request=1', params, function (data) {
    if (typeof data !== 'undefined' && data.success === true) {
      ...
      if (window.location.href.indexOf('?') === -1) {
        ...
        window.location.href += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + 'session_expired=1';
      }
...
Navigation.onload = () => function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('change', '#navi_db_select', function () {
    if (!jquery__WEBPACK_IMPORTED_MODULE_0__(this).val()) {
      _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.set('db', '');
      Navigation.reload();
    }
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree').on('click', 'li.fast_filter button.searchClauseClear', Navigation.FastFilter.events.clear);
  jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree').on('focus', 'li.fast_filter input.searchClause', Navigation.FastFilter.events.focus);
  jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree').on('blur', 'li.fast_filter input.searchClause', Navigation.FastFilter.events.blur);
  jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree').on('keyup', 'li.fast_filter input.searchClause', Navigation.FastFilter.events.keyup);
  /**
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'li.new_view a.ajax', function (event) {
    event.preventDefault();
    _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.createViewModal(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.hideNavItem.ajax', function (event) {
    ...
    params += argSep + 'ajax_request=true' + argSep + 'server=' + _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('server');
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      type: 'POST',
      data: params,
      ...
      success: function (data) {
        if (typeof data !== 'undefined' && data.success === true) {
          ...
          _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(data.error);
        }
      }
    });
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.showUnhide.ajax', function (event) {
    event.preventDefault();
    var $msg = _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage();
    var argSep = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator');
    var params = jquery__WEBPACK_IMPORTED_MODULE_0__(this).getPostData();
    params += argSep + 'ajax_request=true';
    jquery__WEBPACK_IMPORTED_MODULE_0__.post(jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('href'), params, function (data) {
      if (typeof data !== 'undefined' && data.success === true) {
        _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxRemoveMessage($msg);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '.favorite_table_anchor', function (event) {
    ...
    var hasLocalStorage = _config_js__WEBPACK_IMPORTED_MODULE_3__.Config.isStorageSupported('localStorage') && typeof window.localStorage.favoriteTables !== 'undefined';
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      url: $self.attr('href'),
      cache: false,
      type: 'POST',
      ...
      success: function (data) {
        if (data.changes) {
          ...
          _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.tooltip(jquery__WEBPACK_IMPORTED_MODULE_0__('#' + anchorId), 'a', jquery__WEBPACK_IMPORTED_MODULE_0__('#' + anchorId).attr('title')); // Update localStorage.

          if (_config_js__WEBPACK_IMPORTED_MODULE_3__.Config.isStorageSupported('localStorage')) {
            window.localStorage.favoriteTables = data.favoriteTables;
          }
        } else {
          _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(data.message);
        }
      }
    });
  ...
  if (_config_js__WEBPACK_IMPORTED_MODULE_3__.Config.isStorageSupported('sessionStorage')) {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_tree_content').length && typeof storage.navTreePaths === 'undefined') {
      Navigation.reload();
    } else if (_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('server') === storage.server && _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('token') === storage.token) {
...
Navigation.showCurrent = function () {
  var db = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('db');
  var table = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('table');
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_navigation_settings').length) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/navigation&ajax_request=1', params, function (data) {
      if (typeof data !== 'undefined' && data.success) {
        ...
        _config_js__WEBPACK_IMPORTED_MODULE_3__.Config.setupRestoreField();
        _config_js__WEBPACK_IMPORTED_MODULE_3__.Config.setupValidation();
...
Navigation.reload = function (callback, paths) {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('#navi_db_select').length) {
    params.db = _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('db');
...
Navigation.selectCurrentDatabase = function () {
  ...
  if (_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('db')) {
    // db selected
    $naviDbSelect.show();
  }

  $naviDbSelect.val(_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('db'));
  return $naviDbSelect.val() === _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('db');
};
/**
...
Navigation.treePagination = function ($this) {
  var $msgbox = _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage();
  var isDbSelector = $this.closest('div.pageselector').is('.dbselector');
  var url = 'index.php?route=/navigation';
  var params = 'ajax_request=true';

  if ($this[0].tagName === 'A') {
    params += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + $this.getPostData();
  } else {
    // tagName === 'SELECT'
    params += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + $this.closest('form').serialize();
  }

  var searchClause = Navigation.FastFilter.getSearchClause();

  if (searchClause) {
    params += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + 'searchClause=' + encodeURIComponent(searchClause);
  }

  if (isDbSelector) {
    params += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + 'full=true';
  } else {
    var searchClause2 = Navigation.FastFilter.getSearchClause2($this);

    if (searchClause2) {
      params += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + 'searchClause2=' + encodeURIComponent(searchClause2);
    }
  }

  jquery__WEBPACK_IMPORTED_MODULE_0__.post(url, params, function (data) {
    if (typeof data !== 'undefined' && data.success) {
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxRemoveMessage($msgbox);
      var val;
...
Navigation.ResizeHandler = function () {
  ...
  this.mouseup = function (event) {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.configSet('NavigationWidth', event.data.resize_handler.getPos(event));
    jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenu').menuResizer('resize');
  ...
  this.collapse = function (event) {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.configSet('NavigationWidth', panelWidth);
  ...
  this.treeInit = function () {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.configGet('NavigationWidth', false, callbackSuccessGetConfigValue);
  };
...
Navigation.FastFilter.Filter.prototype.request = function () {
  ...
  if (self.$this.find('> ul > li > form.fast_filter').first().find('input[name=searchClause]').length === 0) {
    ...
    if ($input.length && $input.val() !== $input[0].defaultValue) {
      params += _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('arg_separator') + 'searchClause=' + encodeURIComponent($input.val());
    }
  }

  self.xhr = jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
    url: 'index.php?route=/navigation&ajax_request=1&server=' + _common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('server'),
    type: 'post',
    dataType: 'json',
    data: params,
...
Config.isStorageSupported = function (type) {
  ...
  try {
    ...
    // Not supported
    if (warn) {
      _functions_js__WEBPACK_IMPORTED_MODULE_1__.Functions.ajaxShowMessage(window.Messages.strNoLocalStorage, false);
    }
  }
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _ajax_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _functions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
...
var addIndexGo = function (sourceArray, arrayIndex, index, colIndex) {
  ...
  if (!isMissingValue) {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage('<div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt=""' + ' class="icon ic_s_error"> ' + window.Messages.strMissingColumn + ' </div>', false);
    return false;
  }
...
Indexes.showAddIndexDialog = function (sourceArray, arrayIndex, targetColumns, colIndex, index, showDialog) {
  ...
  var $msgbox = _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage();
  jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/table/indexes', postData, function (data) {
    if (data.success === false) {
      // in the case of an error, show the error message returned.
      _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage(data.error, false);
    } else {
      _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxRemoveMessage($msgbox);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#addIndexModalGoButton').on('click', function () {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0__('#composite_index').is(':checked')) {
      if (jquery__WEBPACK_IMPORTED_MODULE_0__('input[name="composite_with"]').length !== 0 && jquery__WEBPACK_IMPORTED_MODULE_0__('input[name="composite_with"]:checked').length === 0) {
        _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage('<div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title=""' + ' alt="" class="icon ic_s_error"> ' + window.Messages.strFormEmpty + ' </div>', false);
        return false;
      }
...
Indexes.on = () => function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#save_index_frm', function (event) {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage(window.Messages.strProcessingRequest);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.drop_primary_key_index_anchor.ajax', function (event) {
    ...
    _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.confirmPreviewSql(question, $anchor.attr('href'), function (url) {
      var $msg = _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage(window.Messages.strDroppingPrimaryKeyIndex, false);
      var params = _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.getJsConfirmCommonParam(this, $anchor.getPostData());
      jquery__WEBPACK_IMPORTED_MODULE_0__.post(url, params, function (data) {
        if (typeof data !== 'undefined' && data.success === true) {
          _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxRemoveMessage($msg);
          ...
          if (data.sql_query) {
            ...
            _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.highlightSql(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
          }

          _navigation_js__WEBPACK_IMPORTED_MODULE_3__.Navigation.reload();
          _common_js__WEBPACK_IMPORTED_MODULE_4__.CommonActions.refreshMain('index.php?route=/table/structure');
        } else {
          _functions_js__WEBPACK_IMPORTED_MODULE_2__.Functions.ajaxShowMessage(window.Messages.strErrorProcessingRequest + ' : ' + data.error, false);
        }
      }); // end $.post()
    });
