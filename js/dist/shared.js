...
const AJAX = {
  ...
  lockPageHandler: function (event) {
    ...
    if (!jquery__WEBPACK_IMPORTED_MODULE_0__.isEmptyObject(AJAX.lockedTargets)) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('#lock_page_icon').html((0,_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_7__["default"])('s_lock', window.Messages.strLockToolTip).toString());
    } else {
  ...
  requestHandler: function (event) {
    ...
    if (AJAX.active === true) {
      ...
      if (AJAX.xhr) {
        ...
        if (AJAX.xhr.status === 0 && AJAX.xhr.statusText === 'abort') {
          // If aborted
          AJAX.$msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(window.Messages.strAbortedRequest);
          AJAX.active = false;
          AJAX.xhr = null;
    ...
    if (isLink) {
      AJAX.active = true;
      AJAX.$msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)();
  ...
  loginResponseHandler: function (data) {
    ...
    if (data.displayMessage) {
      ...
      (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
    }
    ...
    if (data.errors) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_ignore_errors_bottom').on('click', function (e) {
        e.preventDefault();
        (0,_functions_ignorePhpErrors_js__WEBPACK_IMPORTED_MODULE_8__.ignorePhpErrors)();
      });
      jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_ignore_all_errors_bottom').on('click', function (e) {
        e.preventDefault();
        (0,_functions_ignorePhpErrors_js__WEBPACK_IMPORTED_MODULE_8__.ignorePhpErrors)(false);
      });
      ...
      if (data.sendErrorAlways === '1' && data.stopErrorReportLoop !== '1') {
        ...
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(window.Messages.phpErrorsBeingSubmitted, false);
        jquery__WEBPACK_IMPORTED_MODULE_0__('html, body').animate({
    ...
    (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(msg, false);
    ...
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      if (_common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('user') !== data.params.user) {
        ...
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(window.Messages.strLoading, false);
        AJAX.active = false;
        AJAX.xhr = null;
        return;
      }
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(data.error, false);
      AJAX.active = false;
      AJAX.xhr = null;
  ...
  responseHandler: function (data) {
    ...
    if (typeof data === 'string') {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxRemoveMessage)(AJAX.$msgbox);
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(jquery__WEBPACK_IMPORTED_MODULE_0__(data).text(), false, 'error');
      AJAX.active = false;
      AJAX.xhr = null;
      return;
    }
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxRemoveMessage)(AJAX.$msgbox);
      if (data.redirect) {
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(data.redirect, false);
        AJAX.active = false;
        AJAX.xhr = null;
        return;
      }
      AJAX.scriptHandler.reset(function () {
        ...
        if (data.message && data.message.length > 0) {
          ...
          (0,_sql_highlight_js__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#page_content'));
          (0,_functions_checkNumberOfFields_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
        }
        if (data.selflink) {
    ...
    return function (event, request) {
      ...
      if (request.status !== 0 || request.statusText !== 'abort') {
        ...
        if ('responseJSON' in request && 'isErrorResponse' in request.responseJSON && request.responseJSON.isErrorResponse) {
          (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)('<div class="alert alert-danger" role="alert">' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_6__.escapeHtml)(request.responseJSON.error) + '</div>', false);
          AJAX.active = false;
          AJAX.xhr = null;
          return;
        }
        if (request.status !== 0) {
          details += '<div>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_6__.escapeHtml)(window.sprintf(window.Messages.strErrorCode, request.status)) + '</div>';
        }
        details += '<div>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_6__.escapeHtml)(window.sprintf(window.Messages.strErrorText, request.statusText + ' (' + state + ')')) + '</div>';
        if (state === 'rejected' || state === 'timeout') {
          details += '<div>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_6__.escapeHtml)(window.Messages.strErrorConnection) + '</div>';
        }
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)('<div class="alert alert-danger" role="alert">' + window.Messages.strErrorProcessingRequest + details + '</div>', false);
        AJAX.active = false;
        AJAX.xhr = null;
      }
    };
...
Navigation.treeStateUpdate = function () {
  ...
  if (_config_js__WEBPACK_IMPORTED_MODULE_2__.Config.isStorageSupported('sessionStorage')) {
...
Navigation.filterStateRestore = function () {
  if (_config_js__WEBPACK_IMPORTED_MODULE_2__.Config.isStorageSupported('sessionStorage') && typeof window.sessionStorage.navTreeSearchFilters !== 'undefined') {
...
Navigation.onload = () => function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'li.new_view a.ajax', function (event) {
    event.preventDefault();
    (0,_functions_handleCreateViewModal_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '.favorite_table_anchor', function (event) {
    ...
    var hasLocalStorage = _config_js__WEBPACK_IMPORTED_MODULE_2__.Config.isStorageSupported('localStorage') && typeof window.localStorage.favoriteTables !== 'undefined';
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      url: $self.attr('href'),
      cache: false,
      type: 'POST',
      ...
      success: function (data) {
        if (data.changes) {
          ...
          (0,_tooltip_js__WEBPACK_IMPORTED_MODULE_3__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#' + anchorId), 'a', jquery__WEBPACK_IMPORTED_MODULE_0__('#' + anchorId).attr('title'));
          // Update localStorage.
          if (_config_js__WEBPACK_IMPORTED_MODULE_2__.Config.isStorageSupported('localStorage')) {
            window.localStorage.favoriteTables = data.favoriteTables;
          }
        } else {
...
Navigation.treePagination = function ($this) {
  var $msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.post(url, params, function (data) {
    if (typeof data !== 'undefined' && data.success) {
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxRemoveMessage)($msgbox);
      var val;
      if (isDbSelector) {
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(data.error);
      (0,_functions_handleRedirectAndReload_js__WEBPACK_IMPORTED_MODULE_7__["default"])(data);
    }
    Navigation.treeStateUpdate();
  });
};
...
Navigation.ResizeHandler = function () {
  ...
  this.mouseup = function (event) {
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_6__.setConfigValue)('NavigationWidth', event.data.resize_handler.getPos(event));
    jquery__WEBPACK_IMPORTED_MODULE_0__('#topmenu').menuResizer('resize');
  ...
  this.collapse = function (event) {
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_6__.setConfigValue)('NavigationWidth', panelWidth);
  ...
  this.treeInit = function () {
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_6__.getConfigValue)('NavigationWidth', false, callbackSuccessGetConfigValue);
  };
  this.treeInit();
};
