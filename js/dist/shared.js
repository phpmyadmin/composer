...
const AJAX = {
  ...
  requestHandler: function (event) {
    ...
    if (isLink) {
      AJAX.active = true;
      AJAX.$msgbox = (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(); // Save reference for the new link request
  ...
  loginResponseHandler: function (data) {
    ...
    (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_5__.ajaxShowMessage)(msg, false); // bind for php error reporting forms (popup)
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('submit', 'form.create_table_form.ajax', function (event) {
    ...
    if (Functions.checkTableEditForm($form[0], $form.find('input[name=orig_num_fields]').val())) {
      ...
      if (Functions.checkReservedWordColumns($form)) {
        (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_8__.ajaxShowMessage)(window.Messages.strProcessingRequest); // User wants to submit the form
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__.post($form.attr('action'), $form.serialize() + _common_js__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('arg_separator') + 'do_save_data=1', function (data) {
          if (typeof data !== 'undefined' && data.success === true) {
            ...
            (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_8__.ajaxShowMessage)(data.message); // Only if the create table dialog (distinct panel) exists
...
Functions.indexDialogModal = function (routeUrl, url, title, callbackSuccess, callbackFailure) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.post(routeUrl, url, function (data) {
    if (typeof data !== 'undefined' && data.success === false) {
      ...
      (0,_ajax_message_js__WEBPACK_IMPORTED_MODULE_8__.ajaxRemoveMessage)($msgbox); // Show dialog if the request was successful
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      ...
      success: function (data) {
        if (data.changes) {
          ...
          (0,_tooltip_js__WEBPACK_IMPORTED_MODULE_3__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0__('#' + anchorId), 'a', jquery__WEBPACK_IMPORTED_MODULE_0__('#' + anchorId).attr('title')); // Update localStorage.
