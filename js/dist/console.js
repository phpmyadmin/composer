...
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
/* harmony import */ var _console_config_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26);
/* harmony import */ var _functions_config_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(15);
/* harmony import */ var _functions_escape_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
...
var Console = {
  ...
  initialize: function () {
    ...
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_7__.getConfigValue)('Console', false, data => {
  ...
  setupAfterInit: function () {
    ...
    Console.$consoleTemplates = jquery__WEBPACK_IMPORTED_MODULE_0__('#pma_console').find('>.templates');
    ...
    Console.$requestForm.on('submit', _ajax_js__WEBPACK_IMPORTED_MODULE_2__.AJAX.requestHandler);
...
var ConsoleResizer = {
  ...
  mouseDown: function (event) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('mouseup', ConsoleResizer.mouseUp);
...
var ConsoleDebug = {
  ...
  initialize: function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#debug_console').find('.button.order.order_' + order).addClass('active');
  ...
  formatFunctionArgs: function (dbgStep) {
    ...
    if (dbgStep.args.length) {
      ...
      for (var i = 0; i < dbgStep.args.length; i++) {
        $args.append(jquery__WEBPACK_IMPORTED_MODULE_0__('<div class="message">').html('<pre>' + (0,_functions_escape_js__WEBPACK_IMPORTED_MODULE_8__.escapeHtml)(JSON.stringify(dbgStep.args[i], null, '  ')) + '</pre>'));
      }
    }
    return $args;
  },
...
/* harmony export */ });
/* harmony import */ var _functions_config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
...
const Config = {
  ...
  set: function (key, value) {
    this[key] = value;
    (0,_functions_config_js__WEBPACK_IMPORTED_MODULE_0__.setConfigValue)('Console/' + key, value);
  },
  /**
