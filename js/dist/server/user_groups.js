...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('server/user_groups.js', function () {
  ...
  deleteUserGroupModal.on('show.bs.modal', function (event) {
    ...
    this.querySelector('.modal-body').innerText = window.sprintf(window.Messages.strDropUserGroupWarning, (0,_modules_functions_escape_js__WEBPACK_IMPORTED_MODULE_2__.escapeHtml)(userGroupName));
  });
