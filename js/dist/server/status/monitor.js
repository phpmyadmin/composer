...
/* harmony import */ var _modules_functions_createProfilingChart_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(76);
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerTeardown('server/status/monitor.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('a[href="#submitAddSeries"]').off('click');
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('server/status/monitor.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#loadingMonitorIcon').remove();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('a[href="#addNewChart"]').on('click', function (event) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#addChartButton').on('click', function () {
      ...
      newChart.title = jquery__WEBPACK_IMPORTED_MODULE_0__('input[name="chartTitle"]').val();
  ...
  function addChart(chartObj, initialize) {
    ...
    chartObj.chart = jquery__WEBPACK_IMPORTED_MODULE_0__.jqplot('gridchart' + runtime.chartAI, series, settings);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#gridchart' + runtime.chartAI).on('jqplotMouseDown', function (ev, gridpos, datapos) {
      ...
      var selectionBox = jquery__WEBPACK_IMPORTED_MODULE_0__('<div id="selection_box" >');
  ...
  function loadLogStatistics(opts) {
    ...
    function filterQueries(varFilterChange) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__('#logTable').find('table tbody tr td.queryCell').each(function () {
        var $t = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
...
/******/ __webpack_require__.O(0, [44], function() { return __webpack_exec__(75); });
