...
/* harmony import */ var _modules_sql_highlight_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
...
/* harmony import */ var _modules_functions_getImageTag_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19);
...
var processList = {
  ...
  killProcessHandler: function (event) {
    ...
    params += argSep + 'ajax_request=1' + argSep + 'server=' + _modules_common_js__WEBPACK_IMPORTED_MODULE_2__.CommonParams.get('server');
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('server/status/processes.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#tableprocesslist').on('click', 'a.kill_process', processList.killProcessHandler);
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerTeardown('server/status/processes.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#tableprocesslist').off('click', 'thead a');
