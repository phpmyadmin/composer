  ...
  function editVariable(link) {
    ...
    $mySaveLink.on('click', function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0__.post('index.php?route=/server/variables/set/' + encodeURIComponent(varName), {
        ...
        if (data.success) {
          ...
          if (data.error === '') {
            (0,_modules_ajax_message_js__WEBPACK_IMPORTED_MODULE_3__.ajaxShowMessage)(window.Messages.strRequestFailed, false);
          } else {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__.get('index.php?route=/server/variables/get/' + encodeURIComponent(varName), {
      ...
      if (typeof data !== 'undefined' && data.success === true) {
        ...
        $cell.removeClass('edit').html($myEditLink);
        (0,_modules_ajax_message_js__WEBPACK_IMPORTED_MODULE_3__.ajaxShowMessage)(data.error);
      }
    });
  }
});
...
/******/ __webpack_require__.O(0, [44], function() { return __webpack_exec__(82); });
