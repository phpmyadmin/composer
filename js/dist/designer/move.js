...
/* harmony import */ var _modules_functions_refreshMainContent_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23);
/* harmony import */ var _modules_navigation_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerTeardown('designer/move.js', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).off('fullscreenchange');
  jquery__WEBPACK_IMPORTED_MODULE_0__('#selflink').show();
});
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('designer/move.js', function () {
...
DesignerMove.addObject = function (dbName, tableName, colName, dbTableNameUrl) {
  ...
  (0,_modules_ajax_message_js__WEBPACK_IMPORTED_MODULE_4__.ajaxShowMessage)(window.sprintf(window.Messages.strObjectsCreated, sum));
