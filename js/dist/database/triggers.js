...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerTeardown('database/triggers.js', function () {
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('database/triggers.js', function () {
  /**
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.ajax.add_anchor, a.ajax.edit_anchor', function (event) {
    ...
    DatabaseTriggers.editorDialog(jquery__WEBPACK_IMPORTED_MODULE_0__(this).hasClass('add_anchor'), jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.ajax.export_anchor', function (event) {
    event.preventDefault();
    DatabaseTriggers.exportDialog(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', 'a.ajax.drop_anchor', function (event) {
    event.preventDefault();
    DatabaseTriggers.dropDialog(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#bulkActionDropButton', function (event) {
    event.preventDefault();
    DatabaseTriggers.dropMultipleDialog(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  });
});
...
/******/ __webpack_require__.O(0, [44], function() { return __webpack_exec__(39); });
