...
/* harmony import */ var _modules_functions_createProfilingChart_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(76);
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('sql.js', function () {
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_0__('#sqlqueryform').find('button').is('#togglequerybox')) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('<button class="btn btn-secondary" id="togglequerybox"></button>').html(window.Messages.strHideQueryBox).appendTo('#sqlqueryform')
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#button_submit_query', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.alert-success,.alert-danger').hide();
      ...
      if (typeof data !== 'undefined' && data.success === true) {
        ...
        if (typeof data.action_bookmark !== 'undefined') {
          ...
          if ('1' === data.action_bookmark) {
            jquery__WEBPACK_IMPORTED_MODULE_0__('#sqlquery').text(data.sql_query);
            // send to codemirror if possible
            setQuery(data.sql_query);
          }
          // delete
          if ('2' === data.action_bookmark) {
            jquery__WEBPACK_IMPORTED_MODULE_0__('#id_bookmark option[value=\'' + data.id_bookmark + '\']').remove();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('keyup', '.filter_rows', function () {
    ...
    var phrase = jquery__WEBPACK_IMPORTED_MODULE_0__(this).val();
    // Set same value to both Filter rows fields.
    jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_rows[data-for=\'' + uniqueId + '\']').not(this).val(phrase);
    // Handle colspan.
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.post($thisA.attr('href'), params, function (data) {
    ...
    $dialog = jquery__WEBPACK_IMPORTED_MODULE_0__('<div>').append(data.message).dialog({
      ...
      close: function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__(formId).off('submit');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(tableId).on('click', 'td a.foreign_value', function (e) {
      ...
      $input.val(jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('key'));
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(formId).on('submit', function (e) {
      ...
      var postParams = jquery__WEBPACK_IMPORTED_MODULE_0__(this).serializeArray();
