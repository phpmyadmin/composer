...
/* harmony import */ var _modules_functions_escape_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18);
...
function addZoomPanControllers() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#placeholder').append(
  // pan arrows
...
function resizeGISVisualization() {
  ...
  var visWidth = jquery__WEBPACK_IMPORTED_MODULE_0__('#div_view_options').width() - 48;

  // Assign new value for width
  $placeholder.width(visWidth);
  jquery__WEBPACK_IMPORTED_MODULE_0__(gisSvg).attr('width', visWidth);
...
function drawOpenLayerMap() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('#placeholder').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0__('#openlayersmap').show();
...
_modules_ajax_js__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('table/gis_visualization.js', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#zoom_in', function (e) {
    ...
    var height = jquery__WEBPACK_IMPORTED_MODULE_0__(gisSvg).attr('height');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.vector').on('mousemove', function (event) {
    var contents = (0,_modules_functions_escape_js__WEBPACK_IMPORTED_MODULE_2__.escapeHtml)(jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('name')).trim();
