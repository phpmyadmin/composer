      ...
      $.ajax({
        ...
        success: function success(response) {
          ...
          if (response.success) {
            ...
            $('<div></div>').append('<fieldset class="pma-fieldset">' + '<legend>' + operator + '</legend>' + '<label for="min_value">' + Messages.strMinValue + '</label>' + '<input type="text" id="min_value">' + '<br>' + '<span class="small_font">' + min + '</span>' + '<br>' + '<label for="max_value">' + Messages.strMaxValue + '</label>' + '<input type="text" id="max_value">' + '<br>' + '<span class="small_font">' + max + '</span>' + '</fieldset>').dialog({
              width: 'auto',
              maxHeight: 400,
              modal: true,
