...
class PluginsTest extends AbstractTestCase
{
    ...
    public function testGetOptionsForExport(): void
    {
        ...
        $expected = <<<'HTML'
            ...
            <div id="codegen_general_opts"><ul class="list-group"><li class="list-group-item"><input type="hidden" name="codegen_structure_or_data" value="data"><li class="list-group-item">
            ...
            <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" name="csv_columns" value="y" id="checkbox_csv_columns"  checked><label class="form-check-label" for="checkbox_csv_columns">Put columns names in the first row</label></div><li class="list-group-item"><input type="hidden" name="csv_structure_or_data" value="data"></ul></div>
            </div>
            ...
            <label for="select_excel_edition" class="form-label">Excel edition:</label><select class="form-select" name="excel_edition" id="select_excel_edition"><option value="win" selected>Windows</option><option value="mac_excel2003">Excel 2003 / Macintosh</option><option value="mac_excel2008">Excel 2008 / Macintosh</option></select><li class="list-group-item"><input type="hidden" name="excel_structure_or_data" value="data"></ul></div>
            </div>

            <div id="json_options" class="format_specific_options"><h3>JSON</h3>
            <div id="json_general_opts"><ul class="list-group"><li class="list-group-item"><input type="hidden" name="json_structure_or_data" value="data"><li class="list-group-item">
            <div class="form-check form-switch">
            ...
            <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" name="sql_dates" value="y" id="checkbox_sql_dates" ><label class="form-check-label" for="checkbox_sql_dates">Include a timestamp of when databases were created, last updated, and last checked</label></div></ul>
            <li class="list-group-item">
            <div class="form-check form-switch">
            ...
            <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" name="sql_auto_increment" value="y" id="checkbox_sql_auto_increment"  checked><label class="form-check-label" for="checkbox_sql_auto_increment"><code>AUTO_INCREMENT</code> value</label></div></ul>
            ...
            <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" name="sql_or_replace_view" value="y" id="checkbox_sql_or_replace_view" ><label class="form-check-label" for="checkbox_sql_or_replace_view"><code>OR REPLACE</code> view</label></div></ul>
            <li class="list-group-item">
            <div class="form-check form-switch">
            ...
            <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" name="sql_create_trigger" value="y" id="checkbox_sql_create_trigger"  checked><label class="form-check-label" for="checkbox_sql_create_trigger">Add <code>CREATE TRIGGER</code> statement</label></div></ul>
            <li class="list-group-item">
            <div class="form-check form-switch">
            ...
            <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" name="sql_ignore" value="y" id="checkbox_sql_ignore" ><label class="form-check-label" for="checkbox_sql_ignore"><code>INSERT IGNORE</code> statements</label></div><a href="index.php?route=/url&url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.7%2Fen%2Finsert.html" target="mysql_doc"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a></ul>
            <li class="list-group-item">
            ...
            <label for="text_toon_indent" class="form-label">Indentation:</label><input class="form-control" type="text" name="toon_indent" value="2" id="text_toon_indent"><li class="list-group-item"><input type="hidden" name="toon_structure_or_data" value="structure_and_data"></ul></div>
            </div>

            <div id="yaml_options" class="format_specific_options"><h3>YAML</h3>
            <div id="yaml_general_opts"><ul class="list-group"><li class="list-group-item"><input type="hidden" name="yaml_structure_or_data" value="data"></ul></div>
            <p class="card-text">This format has no options</p></div>
