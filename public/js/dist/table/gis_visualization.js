...
function getFeaturesFromOpenLayersData(geometries) {
  ...
  for (const geometry of geometries) {
    ...
    if (geometry.geometry.srid !== 3857) {
      olGeometry = olGeometry.transform('EPSG:' + (geometry.geometry.srid !== 0 ? geometry.geometry.srid : 4326), 'EPSG:3857');
    }
...
/******/ __webpack_require__.O(0, [39], function() { return __webpack_exec__(87); });
