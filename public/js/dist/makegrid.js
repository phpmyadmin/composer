...
const makeGrid = function (t) {
  ...
  var g = {
    ...
    showEditCell: function (cell) {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(cell).is('.grid_edit') && !g.colRsz && !g.colReorder) {
        if (!g.isCellEditActive) {
          ...
          var value = (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.getCellValue)(cell);
          if ($cell.attr('data-type') === 'json' && $cell.is('.truncated') === false) {
            value = (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.stringifyJSON)(value, null, 4);
          }
      ...
      if (data) {
        if (g.currentEditCell) {
          ...
          if (isNull) {
            ...
            if (_modules_common_ts__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('pftext') === 'P' && value.length > g.maxTruncatedLen) {
            ...
            if (!(0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.updateCode)($target, newHtml, value)) {
              $target.html(newHtml);
            }
          }
          if ($thisField.is('.bit')) {
    ...
    showEditArea: function () {
      if (!g.isCellEditActive) {
        ...
        if ($td.is('.relation')) {
            ...
            g.lastXHR = jquery__WEBPACK_IMPORTED_MODULE_0___default().post('index.php?route=/sql', {
              ...
              if (typeof data !== 'undefined' && data.success === true) {
                if ($td.attr('data-type') === 'json') {
                  data.value = (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.stringifyJSON)(data.value, null, 4);
                }
          ...
          // add datetime picker
          (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.addDatepicker)($inputField, $td.attr('data-type'), {
          ...
          $inputField.on('keyup', function (e) {
            if (e.which === 13) {
              ...
              (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.toggleDatepickerIfInvalid)($td, $inputField);
            }
          });
        ...
        $tr.find('.to_be_saved').each(function () {
          ...
          if (isNull) {
            ...
            if ($thisField.attr('data-type') !== 'json') {
              ...
              const JSONString = (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.stringifyJSON)($thisField.data('value'));
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('a').each(function () {
                ...
                if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href').indexOf('DELETE') > -1) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeAttr('onclick').off('click').on('click', function () {
                    return (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_2__.confirmLink)(this, 'DELETE FROM `' + g.db + '`.`' + g.table + '` WHERE ' + decodedNewClause + (isUnique ? '' : ' LIMIT 1'));
                  });
                }
              });
    ...
    initGridEdit: function () {
      ...
      g.maxTruncatedLen = _modules_common_ts__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('LimitChars');
      // register events
        ...
        if ($link.is('.grid_edit.relation a')) {
          ...
          if (clicks === 1) {
            ...
            var timer = setTimeout(function () {
              ...
              _modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.requestHandler.call($link[0]);
              $link.addClass('ajax');
              $cell.data('clicks', 0);
            }, 700);
