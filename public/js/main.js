"use strict";
(self["webpackChunkphpmyadmin"] = self["webpackChunkphpmyadmin"] || []).push([["main"],{
...
/* harmony import */ var _modules_keyhandler_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./resources/js/modules/keyhandler.ts");
/* harmony import */ var _modules_page_settings_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./resources/js/modules/page_settings.ts");
/* harmony import */ var _modules_cross_framing_protection_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./resources/js/modules/cross_framing_protection.ts");
/* harmony import */ var _modules_indexes_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./resources/js/modules/indexes.ts");
/* harmony import */ var _modules_config_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./resources/js/modules/config.ts");
/* harmony import */ var _modules_functions_checkNumberOfFields_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./resources/js/modules/functions/checkNumberOfFields.ts");
/* harmony import */ var _modules_navigation_event_loader_ts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./resources/js/modules/navigation/event-loader.ts");
/* harmony import */ var _modules_functions_event_loader_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./resources/js/modules/functions/event-loader.ts");
/* harmony import */ var _modules_themes_manager_ts__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./resources/js/modules/themes-manager.ts");
...
/***/ "./resources/js/modules/cross_framing_protection.ts":
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/js/modules/functions/event-loader.ts":
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _functions_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./resources/js/modules/functions.ts");
/* harmony import */ var _handleCreateViewModal_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./resources/js/modules/functions/handleCreateViewModal.ts");
...
/***/ "./resources/js/modules/functions/handleCreateViewModal.ts":
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _navigation_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./resources/js/modules/navigation.ts");
/* harmony import */ var _getJsConfirmCommonParam_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./resources/js/modules/functions/getJsConfirmCommonParam.ts");
...
/***/ "./resources/js/modules/keyhandler.ts":
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/js/modules/navigation/event-loader.ts":
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _functions_handleCreateViewModal_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./resources/js/modules/functions/handleCreateViewModal.ts");
/* harmony import */ var _ajax_message_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./resources/js/modules/ajax-message.ts");
...
function updateFavoriteTableButton(buttonId, htmlContent) {
  ...
  (_bootstrap$Tooltip$ge = bootstrap__WEBPACK_IMPORTED_MODULE_1__.Tooltip.getInstance(currentButton)) === null || _bootstrap$Tooltip$ge === void 0 || _bootstrap$Tooltip$ge.dispose();
  currentButton.outerHTML = htmlContent;
  // Enable tooltip of the new button
  new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Tooltip(document.getElementById(buttonId));
}
/**
 * @return {function}
 */
function onloadNavigation() {
  return function () {
    ...
    new _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.ResizeHandler();
    /**
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#pma_navigation_tree a.expander', function (event) {
      ...
      if ($icon.is('.ic_b_plus')) {
        ...
        _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.collapseTreeNode(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
      }
    });
    /**
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#pma_navigation_reload', function (event) {
      ...
      _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.reload(hideNav);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '#navi_db_select', function () {
      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val()) {
        _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.update(_common_ts__WEBPACK_IMPORTED_MODULE_2__.CommonParams.set('db', ''));
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#pma_navigation_sync', function (event) {
      ...
      if (synced) {
        ...
        _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.showCurrent();
      }
    });
    /**
     * Bind all "fast filter" events
     */
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_tree').on('click', 'li.fast_filter button.searchClauseClear', _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.FastFilter.events.clear);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_tree').on('focus', 'li.fast_filter input.searchClause', _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.FastFilter.events.focus);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_tree').on('blur', 'li.fast_filter input.searchClause', _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.FastFilter.events.blur);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_tree').on('keyup', 'li.fast_filter input.searchClause', _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.FastFilter.events.keyup);
    /**
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'li.new_view a.ajax', function (event) {
      event.preventDefault();
      (0,_functions_handleCreateViewModal_ts__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
    });
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        ...
        success: function (data) {
          if (data.changes) {
            ...
            // Update localStorage.
            if ((0,_functions_isStorageSupported_ts__WEBPACK_IMPORTED_MODULE_6__["default"])('localStorage')) {
    ...
    if ((0,_functions_isStorageSupported_ts__WEBPACK_IMPORTED_MODULE_6__["default"])('sessionStorage')) {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_tree_content').length && typeof storage.navTreePaths === 'undefined') {
        ...
        _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.treeStateUpdate();
        _navigation_ts__WEBPACK_IMPORTED_MODULE_3__.Navigation.reload();
      }
    }
  };
...
/***/ "./resources/js/modules/page_settings.ts":
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
