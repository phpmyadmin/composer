"use strict";
(self["webpackChunkphpmyadmin"] = self["webpackChunkphpmyadmin"] || []).push([["table/select"],{
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_1__.AJAX.registerOnload('table/select.js', function () {
   ...
   */
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div id="togglesearchformdiv"><button class="btn btn-sm btn-secondary" type="button" id="togglesearchformlink"></button></div>').insertAfter('#tbl_search_form')
