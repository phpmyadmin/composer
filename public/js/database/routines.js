"use strict";
(self["webpackChunkphpmyadmin"] = self["webpackChunkphpmyadmin"] || []).push([["database/routines"],{

/***/ "./resources/js/database/routines.ts":
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.registerTeardown('database/routines.js', function () {
...
const DatabaseRoutines = {
  ...
  exportDialog: function ($this) {
    ...
    function showExport(data) {
      ...
      routinesExportModal.addEventListener('shown.bs.modal', function () {
        ...
        (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_3__.getSqlEditor)(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#routinesExportTextarea'));
      });
      routinesExportModal.addEventListener('hidden.bs.modal', function () {
        routinesExportModal.querySelector('.modal-body').innerHTML = routinesExportTextarea;
      });
      bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal.getOrCreateInstance(routinesExportModal).show();
    }
  },
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().get($this.attr('href'), {
      ...
      routinesEditorModal.addEventListener('shown.bs.modal', function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input.datefield').each(function () {
          (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_3__.addDatepicker)(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('width', '95%'), 'date');
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input.datetimefield').each(function () {
          (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_3__.addDatepicker)(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('width', '95%'), 'datetime');
        });
        // @ts-ignore
      ...
      bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal.getOrCreateInstance(routinesEditorModal).show();
    });
  },
  ...
  executeDialog: function ($this) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().post($this.attr('href'), params, function (data) {
      ...
      const modal = bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal.getOrCreateInstance(routinesExecuteModal);
      ...
      routinesExecuteModal.addEventListener('shown.bs.modal', function () {
        ...
        modalBody.find('input.datefield, input.datetimefield').each(function () {
          (0,_modules_functions_ts__WEBPACK_IMPORTED_MODULE_3__.addDatepicker)(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('width', '95%'));
        });
        /*
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.registerOnload('database/routines.js', function () {
