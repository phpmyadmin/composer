"use strict";
(self["webpackChunkphpmyadmin"] = self["webpackChunkphpmyadmin"] || []).push([["database/events"],{
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.registerTeardown('database/events.js', function () {
      ...
      function eventsEditorModalSaveEventHandler() {
        ...
        if (that.validate()) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default().post(url, data, function (data) {
            ...
            bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal.getOrCreateInstance('#eventsEditorModal').hide();
...
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.registerOnload('database/events.js', function () {
  /**
...
/******/ __webpack_require__.O(0, ["bootstrap","shared"], function() { return __webpack_exec__("./resources/js/database/events.ts"); });
