"use strict";
(self["webpackChunkphpmyadmin"] = self["webpackChunkphpmyadmin"] || []).push([["database/structure"],{

/***/ "./resources/js/database/structure.ts":
 ...
 */
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.registerTeardown('database/structure.js', function () {
...
function addTooltipToFavoriteIcons() {
  document.querySelectorAll('.favorite_table_anchor').forEach(favoriteTableAnchor => {
    new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Tooltip(favoriteTableAnchor);
  });
}
_modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.registerOnload('database/structure.js', function () {
  /**
    ...
    if (action === 'make_consistent_with_central_list') {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#makeConsistentWithCentralListModal').modal('show').on('shown.bs.modal', function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#makeConsistentWithCentralListContinue').on('click', function () {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default().post('index.php?route=/database/structure/central-columns/make-consistent', data, _modules_ajax_ts__WEBPACK_IMPORTED_MODULE_2__.AJAX.responseHandler);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'a.truncate_table_anchor.ajax', function (event) {
    ...
    }, _modules_functions_ts__WEBPACK_IMPORTED_MODULE_3__.loadForeignKeyCheckbox);
